...
class JideWallpaperPreferences(context: Context) {
    companion object {
        ...
        private const val LOCKSCREEN_USE_NOTE_FIELDS = "lockscreen_use_note_fields"
        ...
        private const val LAUNCHER_USE_NOTE_FIELDS = "launcher_use_note_fields"
    ...
    fun lockscreenUseNoteFields() = prefs.getBoolean(LOCKSCREEN_USE_NOTE_FIELDS, true)
    ...
    fun launcherUseNoteFields() = prefs.getBoolean(LAUNCHER_USE_NOTE_FIELDS, true)
    ...
    fun set(
        deckId: Long,
        lockscreenUseNoteFields: Boolean, lockscreenFirstField: String, lockscreenSecondField: String,
        lockscreenLauncherSame: Boolean,
        launcherUseNoteFields: Boolean, launcherFirstField: String, launcherSecondField: String,
        frequencyMinutes: Int
    ) {
        val edit = prefs.edit()
        edit.putLong(DECK_ID, deckId)
        edit.putBoolean(LOCKSCREEN_USE_NOTE_FIELDS, lockscreenUseNoteFields)
        ...
        edit.putBoolean(LAUNCHER_USE_NOTE_FIELDS, launcherUseNoteFields)
